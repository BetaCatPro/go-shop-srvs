...
import (
	"flag"
	"fmt"
	"go-shop-srvs/userop_srv/handler"
	"go-shop-srvs/userop_srv/utils/register/consul"
	"net"
	"os"
	"os/signal"
	"syscall"
	...
	"go-shop-srvs/userop_srv/global"
	"go-shop-srvs/userop_srv/initialize"
	"go-shop-srvs/userop_srv/proto"
	"go-shop-srvs/userop_srv/utils"
)
